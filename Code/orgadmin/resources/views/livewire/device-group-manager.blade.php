                                    ...
                                    <details class="group open:bg-white open:dark:bg-gray-800 open:shadow-sm open:rounded-lg transition-all duration-300">
                                        <summary class="flex items-center cursor-pointer list-none p-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="text-base font-bold text-gray-800 dark:text-white">{{ $group->name }}</span>
                                                <span class="text-xs {{ $group->status ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400' }}">
                                                    ● {{ $group->status ? 'Active' : 'Inactive' }}
                                                </span>
                                            </div>
                                        </summary>
                                        <div class="pl-10 pr-4 pb-4 pt-2 text-sm text-gray-600 dark:text-gray-300 border-l-2 border-gray-200 dark:border-gray-600 ml-4 mt-1">
                                            @if(!empty($group->subgroup))
                                                <div class="font-semibold text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">Subgroups</div>
                                                <ul class="space-y-2">
                                                    @foreach($group->subgroup as $sub)
                                                        <li class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-900/50 rounded border border-gray-100 dark:border-gray-700 hover:border-purple-200 dark:hover:border-purple-700 transition-colors">
                                                            ...
                                                            <span class="text-xs px-2 py-0.5 rounded-full {{ ($sub['status'] ?? true) ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300' }}">
                                            ...
                                            @else
                                                <span class="italic text-gray-400">No subgroups found.</span>
                                            @endif
                                        </div>
                                    </details>
                                </li>
